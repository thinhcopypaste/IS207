                                        ...
                                        <div class="col-md-4">
                                            <div class="card text-center">
                                                <div class="card-body" style="overflow: hidden">
                                                    ...
                                                    <c:if test="${userDetail.avatar != ''}">
                                                        <img src="/img/avatar/${userDetail.avatar}"
                                                            class="rounded-circle mb-3" id="previewAvatar"
                                                            alt="Profile Picture" style="width: 100%;
                                                     height: auto;
                                                     object-fit: cover;">
                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="p-5">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            ...
                                                            <input type="text" class=" form-control form-control-user"
                                                                ...
                                                                placeholder="${userDetail.firstName}" path="firstName"
                                                                disabled readonly>
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="text" class=" form-control form-control-user"
                                                                ...
                                                                placeholder="${userDetail.lastName}" path="lastName"
                                                                disabled readonly>
                                                            <span class="form-message"></span>
                                                            <!-- ${lastNameError} -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-user "
                                                            id="exampleInputAddress" placeholder="${userDetail.address}"
                                                            path="address" disabled readonly>
                                                        <span class="form-message"></span>
                                                        <!-- ${addressError} -->
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            ...
                                                            <input type="email" class="form-control-user form-control "
                                                                id="exampleInputEmail" placeholder="${userDetail.email}"
                                                                path="email" disabled readonly>
                                                            <span class="form-message"></span>
                                                            <!-- ${emailError} -->
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="tel" class=" form-control form-control-user"
                                                                id="exampleInputPhone" placeholder="${userDetail.phone}"
                                                                path="phone" disabled readonly>
                                                            <span class="form-message"></span>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            ...
                                                            <input type="password"
                                                                ...
                                                                path="password" disabled readonly>
                                                            <!-- ${passwordError} -->
                                                            <span class="form-message"></span>
                                                        ...
                                                        border-radius: 10rem; height: calc(1.5em + .75rem + 2px + 1.15rem);"
                                                                title="Lựa chọn quyền hạn người dùng" disabled>
                                                                <option value="">${userDetail.role.name}</option>
