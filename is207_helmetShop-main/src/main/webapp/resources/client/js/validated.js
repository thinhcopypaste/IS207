...
function Validator(options) {
    ...
    function validate(inputElement, rule) {
        ...
        var a = inputElement.parentElement;
        var errorMessage;
        ...
        if (errorMessage) {
            ...
            inputElement.parentElement.classList.add('p_star');
        ...
        options.rules.forEach(function (rule) {
            ...
            Array.from(inputElements).forEach(function (inputElement) {
                ...
                inputElement.oninput = function () {
                    ...
                    console.log(parent);
                    parent.classList.remove('p_star');
                }
            });
        });
    }
...
Validator.isPhoneVietNamese = function (selector, message) {
    return {
        selector: selector,
        test: function (value) {
