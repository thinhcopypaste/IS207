                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid">
                                <form:form method="POST" action="/admin/product/update"
                                    modelAttribute="updateProductDTO" enctype="multipart/form-data" id="form-1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="p-3">
                                                    <form:input type="hidden" id="productId" path="id" />
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 mb-3 mb-sm-3">
                                                            ...
                                                            <form:textarea class="form-control" id="InputShortDescription"
                                                                rows="3" path="shortDescription"></form:textarea>
                                                        </div>
                                                        <div class="col-sm-12 mb-3 mb-sm-3">
                                                        ...
                                                        <div class="col-sm-12 mb-3 mb-sm-3">
                                                            ...
                                                            <form:select class="form-control" id="categorySelect"
                                                                ...
                                                                path="category_id">
                                                                <c:forEach items="${updateCategoryDTO}" var="category">
                                                                    <c:if
                                                                        test="${category.id == showProductDTO.categoryDTO.id}">
                                                                        <option
                                                                            value=" ${showProductDTO.categoryDTO.id}"
                                                                            label=" ${showProductDTO.categoryDTO.name}"
                                                                            selected>
                                                                        </option>
                                                                    </c:if>
                                                                    <c:if
                                                        ...
                                                        <div class="col-sm-12 mb-3 mb-sm-3" id="addInputSize">
                                                            <c:forEach items="${showProductDTO.product_sizeDTOs}"
                                                                var="product_sizeDTO">
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <span class="form-label">Chọn
                                                                            size</span>
                                                                        <select class="form-control sizeSelect"
                                                                            ...
                                                                            name="sizeIds">
                                                                            <option
                                                                                value="${product_sizeDTO.sizeDTO.id}"
                                                                                label="${product_sizeDTO.sizeDTO.name_size}">
                                                                        </select>
                                                                        <!-- <span class="form-message"></span> -->
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <span class="form-label">Giá
                                                                            bán</span>
                                                                        <input type="number" class="form-control"
                                                                            placeholder="price" name="prices"
                                                                            value="${product_sizeDTO.price}" min="0" />
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <span class="form-label">Số
                                                                            lượng</span>
                                                                        <input type="number" class="form-control"
                                                                            placeholder="" name="qualities"
                                                                            value="${product_sizeDTO.quantity}"
                                                                            min="1" />
                                                                    </div>
                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="p-sm-3 p-3">
                                                    <div class="row">
                                                        <div
                                                            ...
                                                            <label class="btn btn-primary btn-file ">Thumbnail
                                                                <input class="form-control" id="inputImage"
                                                                    name="inputImage" type="file" style="display: none;"
                                                        ...
                                                        <div class="col-sm-6 col-12 mb-4">
                                                            <img id="imagePreview" class="p-1"
                                                                src="/img/product/${showProductDTO.avatar}"
                                                                alt="Ảnh được chọn" accept=".png, .JPG, .jpeg,.webp"
                                                    ...
                                                    <div id="imagePreviewContainer">
                                                        <c:forEach var="image" items="${showProductDTO.imageDTOs}">
                                                            <img id="imagePreview" class="p-1"
                                                                src="/img/product/${image.name_image}"
                                                                alt="Ảnh được chọn" accept=".png, .JPG, .jpeg,.webp"
                                                                style="max-width: 140px;border-radius: 15px;" />
                                                        </c:forEach>
                                                    </div>
                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="p-3">
                                                    <div class="col-sm-12 mb-3 mb-sm-3" id="addInputAttribute">
                                                        <c:forEach items="${showProductDTO.product_attributeDTOs}"
                                                            var="product_attributeDTO">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <label class="form-message">Tên thuộc
                                                                        tính</label>
                                                                    <select class="form-control attributeSelect"
                                                                        style="font-size: .8rem;height: calc(1.5em + .75rem + 2px + 0.5rem);"
                                                                        name="attributes">
                                                                        <option
                                                                            value="${product_attributeDTO.attributeDTO.id}"
                                                                            label="${product_attributeDTO.attributeDTO.title}">

                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <label for="InputDescriptionAttribute">Chi tiết
                                                                        thuộc tính</label>
                                                                    <textarea
                                                                        class="form-control InputDescriptionAttribute"
                                                                        rows="1"
                                                                        name="descriptionAttributes">${product_attributeDTO.description}</textarea>
                                                                </div>
                                                                <div class="col-12 pt-1">
                                                                    <button onclick="removeInputGroup()"
                                                                        class="btn btn-danger btn-sm">Xóa</button>
