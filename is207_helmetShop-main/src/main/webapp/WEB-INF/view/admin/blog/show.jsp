                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <table class="table table-bordered dataTable" id="dataTable"
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="blog" items="${blogsShow}">
                                                                    <tr class="odd">
                                                                        <td class="">${blog.id}</td>
                                                                        <td class="">${blog.title}</td>
                                                                        <td class="">
                                                                            <img id="imagePreview" class="p-1"
                                                                                src="/img/blog/${blog.banner}"
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <form id="deleteForm${blog.id}"
                                                                                action="/admin/blog/delete/${blog.id}"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    onclick="confirmDelete(event,'deleteForm${blog.id}')">
                                                                                    <a href="">
                                                    ...
                                                    <ul class="pagination justify-content-center">
                                                        ...
                                                        <c:forEach begin="0" end="${totalPages - 1}" varStatus="loop">
                                                            <li
                                                                ...
                                                                <a href="/admin/blog?page=${loop.index + 1}"
